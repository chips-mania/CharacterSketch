        ...
        <div className="relative">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="px-3 md:px-4 lg:px-6 py-2.5 md:py-3 bg-black text-white font-semibold rounded-none hover:bg-[#fee800] hover:text-black transition-colors duration-200 shadow-sm flex items-center gap-1 md:gap-2 border-l-0 text-xs md:text-sm lg:text-base"
            >
