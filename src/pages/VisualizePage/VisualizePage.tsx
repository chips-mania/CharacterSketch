...
## 서비스 개요
웹소설 독자의 댓글을 기반으로 웹소설 속 캐릭터를 시각화하는 **독자 참여형 AI 콘텐츠 서비스**입니다.
...
<br/>
이에 웹툰화되기 전, 미리 웹소설 속 캐릭터를 시각화해봄으로써 독자들이 겪는 괴리감을 줄이고자 **캐릭터 스케치**라는 서비스를 기획하게 되었습니다.
...
### 4. 이미지 생성의 일관성 부족:
프롬프트 만으로 일관된 캐릭터를 반복 생성하기 어렵고 독창적인 외모는 구현에 어려움이 있음
