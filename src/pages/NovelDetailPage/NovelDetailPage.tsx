...
### 1. 웹툰 스타일 그림체
웹툰화를 염두에 두고있으므로 웹툰에 적합한 그림체 설정합니다 (실사 이미지 제외).

### 2. 성격이 드러나는 표정
웹소설 속 캐릭터의 성격을 드러내는 표정을 연출합니다.
...
### 4. 보정 및 디테일 추가
Midjourney의 edit 기능을 활용해 디테일을 추가하고 구도를 조정합니다.
...
### 1. 복잡한 프롬프트의 한계
프롬프트에 너무 많은 키워드를 넣은 경우 의도한 결과가 않음
- 핵심 키워드 위주로 간결하게 작성 후 디테일 추가 방식으로 변경

### 2. 과도한 키워드 영향력
특정 키워드(fantasy, anime 등)가 전체 스타일을 과도하게 좌우함
- 키워드를 신중히 선택하고, 가중치를 활용하여 조정
